...
public class ObjectFactory {
    ...
    private final static QName _Convert_QNAME = new QName("http://ws.mohcine.org/", "Convert");
    private final static QName _ConvertResponse_QNAME = new QName("http://ws.mohcine.org/", "ConvertResponse");
    private final static QName _Compte_QNAME = new QName("http://ws.mohcine.org/", "compte");
    private final static QName _GetCompte_QNAME = new QName("http://ws.mohcine.org/", "getCompte");
    private final static QName _GetCompteResponse_QNAME = new QName("http://ws.mohcine.org/", "getCompteResponse");
    private final static QName _ListComptes_QNAME = new QName("http://ws.mohcine.org/", "listComptes");
    private final static QName _ListComptesResponse_QNAME = new QName("http://ws.mohcine.org/", "listComptesResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://ws.mohcine.org/", name = "Convert")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.mohcine.org/", name = "ConvertResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.mohcine.org/", name = "compte")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.mohcine.org/", name = "getCompte")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.mohcine.org/", name = "getCompteResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.mohcine.org/", name = "listComptes")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.mohcine.org/", name = "listComptesResponse")
