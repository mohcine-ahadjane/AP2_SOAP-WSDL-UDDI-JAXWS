 ...
 * 
 */
@WebServiceClient(name = "banqueWS", targetNamespace = "http://ws.mohcine.org/", wsdlLocation = "http://localhost:9191/?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANQUEWS_QNAME = new QName("http://ws.mohcine.org/", "banqueWS");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://ws.mohcine.org/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.mohcine.org/", "BanqueServicePort"), BanqueService.class, features);
    }
